<template>
    <v-layout v-scroll:#scroll-target="onScroll" column>
        <v-flex class="mt-4 text-block" style="width : 100%; margin-bottom : 30px" >
            <div class="left-text" >
                ...
                <img src="../assets/images/hittheants.png" style = "height: 57px; display : inherit; margin-bottom : 30px;">
                점으로부터 시작된<br>
                우주 안 작디작은 은하, 자그마한 행성,<br>
                그 위를 딛고 있는 누군가가 바라보는<br>
                땅 위의 또 다른 점들.<br>
                <br>
                더듬이를 곤두세우고 나선 작은 행보가<br>
                누군가를 이끄는 길이 되기도 합니다.<br>
                땅 위에 남기는 미소한 점의 자취,<br>
                개미들로부터 시작하는 우주를 그립니다<br>
            </div>
        </v-flex>
        <v-flex style="overflow: auto;text-align: -webkit-center;">
            <div id="row">
        ...
        <div>
            <v-flex class="mt-4 introduce-ants" >
                <div class="name">{{memberList[selectedIndex].name}}</div>
                <div class="member-introduce">{{memberList[selectedIndex].introduce}}</div>
    ...
    data() {
        return {
            ...
            memberList: [
                         {
                    name: '정진혁',
                    introduce: '각자의 행복도 집단의 미래도 본인 스스로의 주체적이고 욕망에 집중하는 개인에게 달렸습니다. 변화를 만들어갈 공동체를 이루고 사람들을 동참시켜 이끄는 데에서 큰 자부심과 행복을 느낍니다. 더 많은 사람의 일상을 변화시킬 수 있는 결과물로 세상에 작은 물결을 일으킬 수 있기를 꿈꿉니다.',
                    photo: '',
                    // basePhoto: '/img/imgGhBlack.png',
                    // selectedPhoto: '/img/imgGhColor.png',
                    ...
                    photo: '',
                    // basePhoto: '/img/imgHdBlack.png',
                    // selectedPhoto: '/img/imgHdColor.png',
                    ...
                    name: '김주연',
                    introduce: '안녕하세요, 글쓰기를 좋아하는 개발자입니다. 출근길의 하늘과 사랑하는 사람의 그날 아침 목소리, 저녁에 마주한 생각들의 디테일을 기억하는, 풍부한 삶을 살고 싶습니다. 개발자로서는 팀원들과 함께 발전하며, 새로운 기술을 배우는 걸 두려워하지 않고, 프로젝트에 맞는 최선의 기술 스택을 늘 고민하고 적용하려 노력합니다. 제 삶을 통해 여자도 재능과 야망이 있음을 보여주고자 합니다.',
                    photo: '',
                    // basePhoto: '/img/imgJyBlack.png',
                    // selectedPhoto: '/img/imgJyColor.png',
                    ...
                    // basePhoto: '/img/imgMjBlack.png',
                    // selectedPhoto: '/img/imgMjColor.png',
                    ...
                    photo: '',
                    // basePhoto: '/img/imgJhBlack.png',
                    // selectedPhoto: '/img/imgJhColor.png',
                    ...
                    name: '조현서',
                    introduce: '안녕하세요, 저는 새로운 시각적 경험에 관심이 많아 다양한 매체를 통해 창작하고, 사람들에게 전달하는 일을 하는 조현서라고 합니다. 헤엄이라는 이름으로 활동하고 있으며 앞으로도 분야를 한정 짓지 않고 많은 사람과 재미있는 일들을 해나가고 싶습니다.',
                    photo: '',
                    // basePhoto: '/img/imgHsBlack.png',
                    // selectedPhoto: '/img/imgHsColor.png',
