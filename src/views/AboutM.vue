<template>
    <v-layout v-scroll:#scroll-target="onScroll" column>
        <v-flex class="mt-4 ml-5 introduce-ants" style="opacity: 0.4;">
            “행복의 비결은 현재의 순간을 즐기는 것,<br>
            지금 자기 앞에 있는 일에 몰두하는 것, 땅 위를 걷는 것”<br>
            -베르나르 베르베르 ‘개미’ 중-
        </v-flex>
        <v-flex class="mt-3 ml-5 introduce-ants">
            점으로부터 시작된<br>
        ...
        <v-flex class="mt-4 ml-5 mr-4 introduce-ants">
    ...
    data() {
        return {
            ...
            memberList: [
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgGhBlack.png',
                    selectedPhoto: '/test/img/imgGhColor.png',
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgHbBlack.png',
                    selectedPhoto: '/test/img/imgHbColor.png',
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgHdBlack.png',
                    selectedPhoto: '/test/img/imgHdColor.png',
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgJyBlack.png',
                    selectedPhoto: '/test/img/imgJyColor.png',
                    ...
                    basePhoto: '/test/img/imgMjBlack.png',
                    selectedPhoto: '/test/img/imgMjColor.png',
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgJhBlack.png',
                    selectedPhoto: '/test/img/imgJhColor.png',
                    ...
                    photo: '',
                    basePhoto: '/test/img/imgHsBlack.png',
                    selectedPhoto: '/test/img/imgHsColor.png',
