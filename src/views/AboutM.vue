<template>
    <v-layout v-scroll:#scroll-target="onScroll" column>
        ...
        <v-flex class="mt-3 ml-3 introduce-ants">
            점으로부터 시작된<br>
        ...
        <v-flex class="mt-4 ml-3 mr-4 introduce-ants">
            {{memberList[selectedIndex].introduce}}
        </v-flex>
    </v-layout>
</template>
...
export default {
    ...
    methods: {
        ...
        onResize () {
            ...
            row.style.width = window.innerWidth - 30 + 'px'
        }
    }
